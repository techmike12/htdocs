<?php
    // Check if logged in
    // $_SESSION and $_COOKIE data and messing with how the login info displays in your header
    if (!$_SESSION) {
...
<body id="background">
    ...
    <main>
        <h1>Reviews</h1>
        <!-- Form for reviews and send data to server #front-end and back-end validation -->
    </main>
    <hr id="break">
    <footer>
